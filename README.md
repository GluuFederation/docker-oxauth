...
The latest stable release is `gluufederation/oxauth:3.1.2_01`. Click [here](./CHANGES.md) for archived versions.
...
For example, `gluufederation/oxauth:3.1.2_01` consists of:
...
Pull the image:
    ...
    docker pull gluufederation/oxauth:3.1.2_01
...
docker run -d \
    ...
    -p 8081:8080 \
    gluufederation/oxauth:3.1.2_01
```
